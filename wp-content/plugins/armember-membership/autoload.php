...
class ARMemberlite {
	...
	function arm_enqueue_gutenberg_assets(){
		...
		if( !in_array( $server_php_self, array( 'site-editor.php', 'widgets.php' ) ) ) {
			...
			wp_register_script( 'armlite_gutenberg_script', MEMBERSHIPLITE_URL . '/js/arm_gutenberg_script.js', array( 'wp-blocks', 'wp-element', 'wp-i18n', 'wp-components','wp-editor','wp-block-editor' ), $arm_lite_version );
